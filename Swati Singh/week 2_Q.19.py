...
if a1>a2 and a1>a3 and a1>a4:
    print(f"1st person is the oldest with age {a1}")
elif a2>a1 and a2>a3 and a2>a4:
    print(f"2nd person is the oldest with age {a2}")    
elif a3>a1 and a3>a2 and a3>a4:
    print(f"3rd person is the oldest with age {a3}")
else:
    print(f"4th person is the oldest with age {a4}")
